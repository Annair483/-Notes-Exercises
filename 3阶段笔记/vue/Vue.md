...
* MVC
    ...
    * 控制器（Controller）：业务逻辑处理（M和V之间的连接器）
    ...
    ![MVC](http://ww1.sinaimg.cn/large/006D2wm8gy1g0vjfkm3tcj30gp0a5dfm.jpg)
...
* MVP
    ...
    * Presenter 可以理解为松散的控制器，其中包含了视图的 UI 业务逻辑，所有从视图发出的事件，都会通过代理给 Presenter 进行处理；同时，Presenter 也通过视图暴露的接口与其进行通信。
    ...
    ![MVP](http://ww1.sinaimg.cn/large/006D2wm8gy1g0vjg68wfoj30dw08274h.jpg)
...
* MVVM
    ...
    * ViewModel  类似与MVP中的Presenter，唯一的区别是，它采用双向绑定：View的变动，自动反映在 ViewModel，反之亦然
    ...
    ![MVVM](http://ww1.sinaimg.cn/large/006D2wm8gy1g0vjgsf2q6j30fg0brdfm.jpg)
...
![生命周期](http://ww1.sinaimg.cn/large/006D2wm8gy1g0we82twovj30xc2cf10v.jpg)

![生命周期版本对比](http://ww1.sinaimg.cn/large/006D2wm8gy1g0wcmv596uj30m80ct40o.jpg)
