...
```bash 
     mongoimport -d mongotest -c goods --file D:/data/goods.json --type json
      mongoimport -d reactProject -c goodlist --file C:\Users\Administrator\Desktop\React-GouJiuWang-App-And-BMS-Pc\backend\node\database\goodlist.csv --type csv --headerline 
```
